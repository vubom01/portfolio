        ...
        <div className="grid grid-cols-3 gap-4 gap-x-14">
          <div className="col-span-3 lg:col-span-2">
            ...
            <p>
              ...
              expenses. Whether you are sharing a vacation with friends,
              splitting the bill with roommates, or managing shared expenses
              with a group, our intuitive expense splitter and split money
              calculator ensure everyone contributes fairly. From shared
              expenses to shared adventures, MemoGo is your ultimate companion
